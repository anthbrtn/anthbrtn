...
#+author:
#+OPTIONS: toc:nil
#+HTML_HEAD: <style> @import url('https://fonts.googleapis.com/css2?family=Dosis:wght@600&display=swap'); </style> <link rel="stylesheet" type="text/css" href="style.css"\>
* General information
...
Jucan, Ioana B., Vasudevan, Roopa, Burton, Anthony Glyn, Wu, Tong, & Zhang, Yuguang. "Left and Right, Or Being who/where you are" /Theater Journal/. Video essay. In revision, 2021.
